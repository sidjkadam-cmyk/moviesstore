...
SECRET_KEY = 'django-insecure-rrj0eg44bv)jxrz@g4!8+in=!8+trye-l-x6fp@m%90qupxo)3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'sidjkadam.pythonanywhere.com']

CSRF_TRUSTED_ORIGINS = [
    'https://sidjkadam.pythonanywhere.com'
]
